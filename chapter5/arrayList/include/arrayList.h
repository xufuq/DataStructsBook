...
public:
    ...
    bool operator<(arrayList<T>& right);
    void operator=(arrayList<T>& right);
    // Q11
...
template <class T>
bool arrayList<T>::operator<(arrayList<T>& right)
{
...
template <class T>
void arrayList<T>::operator=(arrayList<T>& theList)
{
    arrayLength = theList.arrayLength;
    listSize = theList.listSize;
    element = new T[arrayLength];
